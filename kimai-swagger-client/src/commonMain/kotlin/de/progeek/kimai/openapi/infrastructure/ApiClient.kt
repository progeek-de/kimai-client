package de.progeek.kimai.openapi.infrastructure

import de.progeek.kimai.openapi.auth.*
...
open class ApiClient(
    ...
    private val authentications: kotlin.collections.Map<String, Authentication> by lazy {
        mapOf(
                "apiUser" to ApiKeyAuth("header", "X-AUTH-USER"), 
                "apiToken" to ApiKeyAuth("header", "X-AUTH-TOKEN"))
    }
