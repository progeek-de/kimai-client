...
import de.progeek.kimai.shared.ui.form.activity.ActivityFieldStore.Intent
import dev.icerock.moko.resources.compose.stringResource

@Composable
fun ActivityField(component: ActivityFieldComponent) {
    ...
    Row(modifier = Modifier.fillMaxWidth()
        ...
        ItemDropDown(
            ...
            currentSelected = state.selectedActivity,
            mapItemToString = { it.name },
            required = true,
            placeholder = stringResource(SharedRes.strings.select_activity)
        ) {
            component.onIntent(Intent.SelectedActivity(it))
        }
    }
}